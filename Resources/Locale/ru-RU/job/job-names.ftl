...
job-name-serviceworker = Наемник Colonel Sanders
...
job-name-reporter = Греческая DYK
job-name-musician = Агент IDF
job-name-librarian = Охранник BABA TAPA INC
job-name-lawyer = Мятежники Саха
job-name-mime = Пираты Булунского улуса
job-name-ce = старший инженер
job-name-janitor = Оперативник Дельта
job-name-chaplain = священник
job-name-botanist = ботаник
job-name-bartender = бармен
job-name-passenger = Сепаратист
