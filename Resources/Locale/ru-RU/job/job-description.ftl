...
job-description-janitor = [КТ] Защитите цель.
job-description-lawyer = [Т] Выполните задачу.
job-description-librarian = [КТ] Защитите активы компании.
job-description-mime = [Т] Выполните задачу.
job-description-musician = [КТ] Защитите цель.
job-description-passenger = [Т] Выполните задачу.
...
job-description-reporter = [КТ] Защитите цель.
...
job-description-serviceworker = [Т] Выполните задачу.
