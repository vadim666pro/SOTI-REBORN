...
ui-options-hud-theme-halflife = Half-Life
ui-options-hud-accent-color = Акцентный цвет HUD:
ui-options-hud-accent-color-default = По умолчанию
ui-options-hud-accent-color-amber = Янтарный (HL2)
ui-options-hud-accent-color-orange = Оранжевый
ui-options-hud-accent-color-yellow = Жёлтый
ui-options-hud-accent-color-green = Зелёный
ui-options-hud-accent-color-blue = Синий
ui-options-hud-accent-color-red = Красный
ui-options-hud-accent-color-white = Белый
