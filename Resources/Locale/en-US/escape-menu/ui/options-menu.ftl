...
ui-options-hud-accent-color = HUD accent color:
ui-options-hud-accent-color-default = Theme default
ui-options-hud-accent-color-amber = Amber (HL2)
ui-options-hud-accent-color-orange = Orange
ui-options-hud-accent-color-yellow = Yellow
ui-options-hud-accent-color-green = Green
ui-options-hud-accent-color-blue = Blue
ui-options-hud-accent-color-red = Red
ui-options-hud-accent-color-white = White
