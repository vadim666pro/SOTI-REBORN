...
job-name-serviceworker = Colonel Sanders Merc
job-name-centcomoff = CentComm Official
job-name-cburn = Centcomm Quarantine Officer
job-name-deathsquad = Centcomm Agent
job-name-reporter = Greek DYK
job-name-musician = IDF Agent
job-name-librarian = BABA TAPA INC Security
job-name-lawyer = Sakha Rebels
job-name-mime = Pirates of Bulunsky Ulus
job-name-ce = Chief Engineer
job-name-janitor = Delta Operative
job-name-chaplain = Anarchist
job-name-botanist = Botanist
job-name-bartender = Bartender
job-name-passenger = Separatist
