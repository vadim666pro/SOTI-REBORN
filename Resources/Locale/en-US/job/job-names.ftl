job-name-warden = Chicka The Chicken
job-name-security = Freddy Fazbear's Security
job-name-cadet = Bonnie The Bunny
job-name-hos = Foxy The Pirate
job-name-detective = Freddy Fazbear
...
job-name-serviceworker = Colonel Sanders' mercenary KFC
job-name-centcomoff = CentComm Official
job-name-cburn = Centcomm Quarantine Officer
job-name-deathsquad = Centcomm Agent
job-name-reporter = Greek Soldier
job-name-musician = Isralian Soldier
job-name-librarian = Baba Tapa INC's mercenary
job-name-lawyer = Siberian Separatist
job-name-mime = Pirate of Bulunsky Ulus
job-name-ce = Chief Engineer
job-name-janitor = FSB Alpha
job-name-chaplain = Anarchist
job-name-botanist = Botanist
job-name-bartender = Bartender
job-name-passenger = Islamic Separatist
